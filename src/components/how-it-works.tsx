            ...
            <Reveal key={s.step} delay={i * 120} className="h-full">
              <TiltCard maxTilt={8} className="h-full">
                <div className="relative h-full rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-shadow duration-300 hover:shadow-3d">
                  ...
                  <div
                    className={`mt-2 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${s.accent} text-white shadow-lg shadow-indigo-500/25 transition-transform duration-300`}
                  >

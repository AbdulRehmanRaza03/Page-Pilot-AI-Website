  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-indigo-50/60 via-white to-white">
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-20 text-center sm:pt-28">
        <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-white/80 px-4 py-1.5 text-sm font-medium text-indigo-700 shadow-sm backdrop-blur">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link
            href="#how-it-works"
            className="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-7 py-3.5 text-base font-semibold text-navy transition-all hover:-translate-y-0.5 hover:bg-slate-50 hover:shadow-md"
          >
            See how it works
          </Link>
        </div>
          ...
          <TiltCard maxTilt={6} className="rounded-3xl">
            <div className="card-3d relative rounded-3xl border border-slate-200 bg-white/90 p-2 shadow-3d-lg backdrop-blur">
              ...
              <div className="flex items-center gap-2 rounded-2xl bg-slate-50 px-4 py-3">
                ...
                <div className="ml-4 hidden items-center gap-2 rounded-md bg-white px-3 py-1.5 text-xs text-slate-400 shadow-sm sm:flex">
              ...
              <div className="grid gap-3 p-3 sm:grid-cols-3">
                {/* Sidebar */}
                <div className="hidden flex-col gap-2 rounded-2xl bg-slate-50 p-3 sm:flex">
                  {[
                ...
                <div className="col-span-1 flex flex-col gap-3 sm:col-span-2">
                  <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-3">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-navy">
                        1,284{" "}
                        <span className="align-middle text-xs font-medium text-emerald-500">
                          ↑ 24%
                        </span>
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white p-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-full bg-indigo-50 text-brand-600">
        ...
        <div className="mx-auto mt-16 grid max-w-4xl grid-cols-2 gap-4 sm:grid-cols-4">
          {[
            ...
            <div
              key={f.label}
              className="animate-float flex flex-col items-center gap-2 rounded-2xl border border-slate-200 bg-white/80 p-5 shadow-sm backdrop-blur transition-transform hover:-translate-y-1 hover:shadow-md"
